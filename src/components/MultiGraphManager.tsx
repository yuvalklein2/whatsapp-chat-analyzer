    ...
    <div className="space-y-10">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <button
          ...
          className="group relative overflow-hidden flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:ring-offset-2 transition-all duration-300"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-8">
          {chartConfigs.map((config, index) => (
            ...
            >
              ...
              {/* Chart Header */}
              <div className="relative flex items-center justify-between p-6 border-b border-gray-200/50 group-hover:border-gray-300/50 transition-colors duration-300">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-1 px-2 py-1 bg-gradient-to-r from-green-50 to-emerald-50 rounded-full">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="group/btn p-2.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all duration-300 hover:scale-110"
                  ...
                  <button
                    ...
                    className="group/btn p-2.5 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-300 hover:scale-110"
                    title="Remove chart"
                  >
      ...
      {/* Empty State */}
      {chartConfigs.length === 0 && (
        <div className="relative bg-white/50 backdrop-blur-xl rounded-3xl p-20 text-center border border-gray-200/50 shadow-lg overflow-hidden">
          {/* Animated background */}
